...
taken from https://github.com/getpelican/pelican-plugins/tree/master/gzip_cache
licensed under AGPL according to https://github.com/getpelican/pelican-plugins/blob/master/LICENSE
'''
